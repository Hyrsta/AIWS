/* ============================================================
   UI atoms — Icon (Lucide-style inline SVG), Chip, StatusDot
   Ported verbatim from AIWS Design Reference aiws/ui.jsx
   ============================================================ */
import type { CSSProperties } from "react";

export type IconName =
  | "box" | "plus" | "upload" | "image" | "x" | "check" | "checkCircle"
  | "alert" | "download" | "folder" | "cpu" | "activity" | "layers"
  | "ruler" | "scan" | "clock" | "chevR" | "chevD" | "globe" | "refresh"
  | "terminal" | "gauge" | "play" | "copy" | "arrowR" | "zap" | "info"
  | "crosshair" | "file" | "cube3d" | "sliders" | "target" | "ban" | "stop";
...
const ICONS: Record<IconName, string> = {
  ...
  cube3d: '<path d="M12 2 2 7l10 5 10-5-10-5Z"/><path d="m2 17 10 5 10-5"/><path d="m2 12 10 5 10-5"/>',
...
export function Icon({ n, size = 18, sw = 2, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export type ChipTone = "sig" | "ok" | "warn" | "bad" | "info" | "copper" | "";
...
export function Chip({ tone = "", dot, icon, style, children }: ChipProps) {
  return (
    <span className={"chip " + tone} style={style}>
      {dot ? <span className="d" style={{ background: "currentColor" }} /> : null}
...
export type StatusKind = "running" | "completed" | "failed" | "terminated" | "queued" | "";
