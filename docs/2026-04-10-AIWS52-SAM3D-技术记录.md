...
| Shard | GPU | 完成 | `avg_ok_duration_sec` (s) | `ok_instances_per_hour` |
|---|---:|---:|---:|---:|
...
| 维度 | 样本数 | `duration_mean_sec` | `duration_p90_sec` | 结论 |
|---|---:|---:|---:|---|
| `V1 / bellmouth` | 194 | 17.8334 | 34.9408 | 明显高于整体均值，是本轮主要长尾瓶颈 |

该结果与运行过程中的实时现象一致，后期 shard-3 在进入 `V1/bellmouth` 密集区间时显著慢于其他 shard。
