...
这里更准确的表述应该是：**AIWS 分为 online pipeline 和 offline pipeline 两部分**，而本文讨论的 CAD 重建管线就是其中的 **offline pipeline**。
...
- `scripts/run_sam3d_to_cadrille_e2e.py`：将 SAM3D 输出桥接到 Cadrille，下游汇总也由该脚本产出
