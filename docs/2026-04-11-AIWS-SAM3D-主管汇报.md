...
- `scripts/dataset_usable_view_build.py`：构建 `aiws5.2-usable/` 的正式数据视图
- `scripts/dataset_instance_masks_generate.py`：从标注生成实例级 mask/中间数据
- `scripts/sam3d_batch.py`：SAM3D 全量批处理脚本，支持 resume、shard、多卡与运行指标记录
