...
|---|---:|---:|---:|---:|---:|
| 单样本运行时间 (s) | 14.799 | 13.812 | 17.555 | 18.977 | 73.562 |
| 每百万像素运行时间 (s/MP) | 7.374 | 6.664 | 8.505 | 9.359 | 51.063 |

### 4.1.4 显存统计（1418 样本）

| 指标 | Mean | P50 | P90 | P95 | Max |
|---|---:|---:|---:|---:|---:|
| 平均实际占用显存 (MB) | 18709.201 | 18738.090 | 19428.319 | 19614.863 | 20071.270 |
| 峰值显存上界 (MB) | 24647.275 | 24936.000 | 26420.000 | 27136.000 | 28076.000 |
...
| 数据版本 | 工件类型 | 样本数 | 平均运行时间 (s) | P90 运行时间 (s) | 平均实际占用显存 (MB) | 峰值显存上界 (MB) |
|---|---|---:|---:|---:|---:|---:|
| V1 | cover_plate（盖板） | 200 | 13.9323 | 16.7683 | 18695.6 | 28024.0 |
| V1 | square_tube（方管） | 99 | 16.3360 | 17.2780 | 19110.4 | 27336.0 |
| V1 | h_beam（H 型钢） | 100 | 11.9246 | 13.2744 | 18131.8 | 24856.0 |
| V1 | channel_steel（槽钢） | 0 | — | — | — | — |
| V1 | bellmouth（喇叭口） | 194 | 17.8334 | 34.9408 | 18297.3 | 26298.0 |
| V2 | cover_plate（盖板） | 524 | 14.6590 | 17.4729 | 18899.0 | 28044.0 |
| V2 | square_tube（方管） | 0 | — | — | — | — |
| V2 | h_beam（H 型钢） | 0 | — | — | — | — |
| V2 | channel_steel（槽钢） | 0 | — | — | — | — |
| V2 | bellmouth（喇叭口） | 0 | — | — | — | — |
| NEW | cover_plate（盖板） | 301 | 14.1106 | 17.9950 | 18713.1 | 28076.0 |
