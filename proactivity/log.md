...
- 2026-04-10: Confirmed the AIWS5.2 materialized dataset view contains 1441 annotated image files and 1475 total object instances across train and val.
- 2026-04-10: Unzipped the materialized AIWS5.2 dataset zip on `RXL`, created `scripts/run_sam3d_aiws52_batch.py`, and smoke-tested it successfully on one real sample.
